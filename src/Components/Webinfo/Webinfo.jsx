  ...
  return (
    <div className="webinfo-container">
      <div className="webinfo-content">
        ...
        <p className="webinfo-link">You can view the live website <a href="https://buddhadebkoner.github.io/React-Portfolio/">here</a>.</p>
        ...
        <div className="webinfo-section">
          ...
          <pre className="webinfo-code"><code>cd React-Portfolio</code></pre>
        </div>
        <div className="webinfo-section">
